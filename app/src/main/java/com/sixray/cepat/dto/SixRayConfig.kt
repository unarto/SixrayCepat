...
//                    }
        ...
        fun ensureSockopt(): SixRayConfig.OutboundBean.StreamSettingsBean.SockoptBean {
            val stream = streamSettings ?: SixRayConfig.OutboundBean.StreamSettingsBean().also {
                streamSettings = it
            }

            val sockopt = stream.sockopt ?: SixRayConfig.OutboundBean.StreamSettingsBean.SockoptBean().also {
                stream.sockopt = it
            }
