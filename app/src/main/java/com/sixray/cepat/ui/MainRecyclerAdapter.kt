...
import com.sixray.cepat.AngApplication.Companion.application
import com.sixray.cepat.AppConfig
import com.sixray.cepat.R
import com.sixray.cepat.databinding.ItemQrcodeBinding
import com.sixray.cepat.databinding.ItemRecyclerFooterBinding
import com.sixray.cepat.databinding.ItemRecyclerMainBinding
...
import com.sixray.cepat.helper.ItemTouchHelperAdapter
import com.sixray.cepat.helper.ItemTouchHelperViewHolder
...
//        }
    ...
    private fun setSelectServer(guid: String) {
        ...
        if (guid != selected) {
            ...
            if (isRunning) {
                SixRayServiceManager.stopVService(mActivity)
                mActivity.lifecycleScope.launch {
                    try {
                        delay(500)
                        SixRayServiceManager.startVService(mActivity)
                    } catch (e: Exception) {
