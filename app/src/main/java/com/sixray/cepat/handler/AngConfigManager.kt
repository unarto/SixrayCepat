...
import com.sixray.cepat.AppConfig.HY2
...
object AngConfigManager {
    ...
    fun shareFullContent2Clipboard(context: Context, guid: String?): Int {
        try {
            ...
            val result = SixRayConfigManager.getSixRayConfig(context, guid)
            if (result.status) {
    ...
    fun createIntelligentSelection(
        ...
        val result = SixRayConfigManager.genSixRayConfig(context, guidList) ?: return null
