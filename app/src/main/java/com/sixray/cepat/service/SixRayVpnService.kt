...
class SixRayVpnService : VpnService(), ServiceControl {
    ...
    override fun onCreate() {
        ...
        SixRayServiceManager.serviceControl = SoftReference(this)
    }
...
//    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        if (SixRayServiceManager.startCoreLoop()) {
            startService()
        }
        return START_STICKY
    ...
    private fun configureNetworkSettings(builder: Builder) {
        ...
        builder.setSession(SixRayServiceManager.getRunningServerName())
    }
...
//        saveVpnNetworkInfo(configName, info)
        ...
        SixRayServiceManager.stopCoreLoop()
